...
# TODO add {ids}
${get_urls}     curators/consumers  curators/info   curators
${post_urls}    curators/login      curators/users      curators/notifications  curators
${put_urls}     curators/many   curators/{id}
${delete_urls}  curators/many   curators/{id}
